...
#include "../ch02/Bitmap.h"  
#include "../_share/primeNLT.hpp"  
...
Hashtable<K, V>::Hashtable(int c){
    M = primeNLT(c, 1048576, "../_share/prime-1048576-bitmap.txt");
    N = 0;
    ht = new Entry<K, V>*[M];
...
void Hashtable<K, V>::rehash() {
   ...
   M = primeNLT( 4 * N, 1048576, "../_share/prime-1048576-bitmap.txt"); //容量至少加倍（若懒惰删除很多，可能反而缩容）
   ht = new Entry<K, V>*[M]; 
